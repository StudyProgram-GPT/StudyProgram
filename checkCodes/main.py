import subprocess
import signal
from checkCode.check01 import issue01
from checkCode.check02 import issue02
...
def time_limit(seconds):
    def signal_handler(signup, frame):
        raise TimeoutException("タイムアウト")

    signal.signal(signal.SIGNALERS, signal_handler)
